...
def main():
    ...
    pygame.display.set_caption('飞机大战2.0')

    # 创建游戏背景
    back=random.choice(range(2))
        ...
        if die==False:
            ...
            for e in enemy_list:
                ...
                if e.y >= 700:
                    enemy_list.remove(e)
                #检测是否与玩家飞机碰撞
                if (e.x>hero.x and e.x<hero.x+106 and e.y+30>hero.y+15 and e.y+30<hero.y+42)or (e.x+104>hero.x and e.x+104<hero.x+106 and e.y+30>hero.y+15 and e.y+30<hero.y+42)or (e.x>hero.x and e.x<hero.x+106 and e.y+62>hero.y+15 and e.y+62<hero.y+42)or (e.x+104>hero.x and e.x+104<hero.x+106 and e.y+62>hero.y+15 and e.y+62<hero.y+42):
                    for i in range(0, 4):
                        for j in range(10):
                            screen.blit(pygame.image.load('./images/bomb' + str(i) + '.png'), (e.x, e.y))
